...
class eventos_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        ob_start();
        include( TEMPLATEPATH . '/template-parts/widgets/widget-eventos-portada.php');
        $aside = ob_get_clean();
        echo $aside;
...
class novedades_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        // This is where you run the code and display the output
        ob_start();
        include( TEMPLATEPATH . '/template-parts/widgets/widget-novedades-portada.php');
        $aside = ob_get_clean();
        echo $aside;
...
class talleres_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        // This is where you run the code and display the output
        ob_start();
        include( TEMPLATEPATH . '/template-parts/widgets/widget-talleres-portada.php');
        $aside = ob_get_clean();
        echo $aside;
...
public function widget( $args, $instance ) {
    ...
    // This is where you run the code and display the output
    ob_start();
    include( TEMPLATEPATH . '/template-parts/widgets/widget-novedades-sidebar.php');
    $aside = ob_get_clean();
    echo $aside;
...
public function widget( $args, $instance ) {
    ...
    // This is where you run the code and display the output
    ob_start();
    include( TEMPLATEPATH . '/template-parts/widgets/widget-eventos-sidebar.php');
    $aside = ob_get_clean();
    echo $aside;
